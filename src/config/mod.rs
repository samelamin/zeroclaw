...
pub use schema::{
    ...
    PeripheralBoardConfig, PeripheralsConfig, PipelineConfig, PiperTtsConfig, PlaywrightMcpConfig,
    PluginsConfig, ProjectIntelConfig, ProxyConfig, ProxyScope, QdrantConfig, QueryClassificationConfig,
